  ...
  await seed(db, schema, { count: 3, seed: SEED }).refine((f) => ({
    user: {
      ...
      columns: {
        ...
        full_email: f.valuesFromArray({ values: emails1, isUnique: true }),
  ...
  await seed(db, schema, { count: 5, seed: SEED + 100 }).refine((f) => ({
    user: {
      ...
      columns: {
        ...
        full_email: f.valuesFromArray({ values: emails2, isUnique: true }),
        emailVerified: f.default({ defaultValue: false }),
        image: f.default({ defaultValue: null }),
        createdAt: f.timestamp(),
        updatedAt: f.timestamp(),
    ...
    post: {
      columns: {
        ...
        private: f.default({ defaultValue: false }),
        createdAt: f.timestamp(),
        updatedAt: f.timestamp(),
      },
    },
  ...
  await seed(db, schema, { count: 7, seed: SEED + 200 }).refine((f) => ({
    user: {
      ...
      columns: {
        ...
        full_email: f.valuesFromArray({ values: emails3, isUnique: true }),
        emailVerified: f.default({ defaultValue: false }),
        image: f.default({ defaultValue: null }),
        createdAt: f.timestamp(),
        updatedAt: f.timestamp(),
